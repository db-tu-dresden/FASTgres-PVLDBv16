...
AND (t1.name in ('android-gradle','capistrano','complexity-theory','conv-neural-network','hibernate-mapping','jhipster','microsoft-metro','phonegap-plugins','struct','webrtc'))
